  ...
  return (
    ...
    >
      <div className="kads-container relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 min-[1600px]:gap-8">
          {PILLARS.map((pillar, idx) => {
            ...
            return (
              <motion.div
                ...
                className="kads-card p-8 sm:p-10 min-[1600px]:p-12 flex flex-col justify-between"
              >
                <div>
                  <div className="flex items-center justify-between mb-6">
                    <span className="text-xs font-bold text-[var(--kads-text-subtle)] uppercase tracking-widest font-mono">
