...
export default function ProcessPage() {
  return (
    <main className="relative min-h-screen bg-white text-black selection:bg-black selection:text-white font-sans">
        ...
        <div className="w-[90%] max-w-[1500px] mx-auto relative z-10">
          <div className="max-w-4xl">
            ...
            <h1 className="text-4xl sm:text-6xl lg:text-7xl font-light text-white tracking-tight leading-[1.08] mb-6">
              A Disciplined Engineering & <span className="font-serif italic font-normal text-zinc-300">Creative</span> Methodology.
            </h1>
      ...
      {/* Process Stages */}
      <section className="py-24 sm:py-32 bg-white text-black relative border-b border-zinc-200">
        <div className="w-[90%] max-w-[1500px] mx-auto relative z-10 space-y-8">
          {STAGES.map((stage) => (
            <div
              key={stage.number}
              className="p-8 sm:p-12 rounded-3xl bg-white border border-zinc-200 grid grid-cols-1 lg:grid-cols-12 gap-8 items-start shadow-xs hover:border-black transition-colors"
            >
              <div className="lg:col-span-4 space-y-2">
                <span className="text-4xl sm:text-5xl font-mono font-light text-black block">
                  [{stage.number}]
                </span>
                <span className="text-xs font-mono uppercase tracking-wider text-zinc-400 block">
                  TIMELINE: {stage.duration}
                </span>
                <h2 className="text-2xl sm:text-3xl font-bold text-black pt-2">
                  {stage.title}
                </h2>
              </div>
              ...
              <div className="lg:col-span-8 space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-4 border-t border-zinc-200">
                  {stage.activities.map((act, i) => (
                    <div key={i} className="flex items-center gap-2.5 text-xs font-medium text-black p-3.5 rounded-xl bg-zinc-50 border border-zinc-200">
